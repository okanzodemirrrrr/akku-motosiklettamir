...
export default async function SatilikBisikletler() {
  const { data: listings, error } = await getListings('satilik', 'bisiklet');
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-asphalt-300">
            İkinci el bisiklet ve elektrikli bisiklet ilanlarımız
          </p>
        </div>
        ...
        {listings && listings.length > 0 ? (
          ...
          <div className="text-center text-asphalt-400 py-16">
            <p className="text-xl">Şu anda satılık bisiklet ilanı bulunmamaktadır.</p>
          </div>
        )}
      </div>
    </main>
