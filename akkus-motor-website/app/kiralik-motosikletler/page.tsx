...
export default async function KiralikMotosikletler() {
  const { data: listings, error } = await getListings('kiralik', 'motosiklet');
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-asphalt-300">
            Günlük ve haftalık kiralık motosiklet seçeneklerimiz
          </p>
        </div>
        ...
        {listings && listings.length > 0 ? (
          ...
          <div className="text-center text-asphalt-400 py-16">
            <p className="text-xl">Şu anda kiralık motosiklet ilanı bulunmamaktadır.</p>
          </div>
        )}
      </div>
    </main>
